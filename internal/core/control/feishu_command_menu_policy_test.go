...
func TestFeishuMenuGroupClassificationMatchesTaskModel(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			want:    []string{FeishuCommandProject, FeishuCommandContinue, FeishuCommandStop, FeishuCommandCompact, FeishuCommandSteerAll, FeishuCommandNew, FeishuCommandStatus},
		},
		{
