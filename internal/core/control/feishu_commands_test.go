...
func TestFeishuCommandRegistryActionRoundTrip(t *testing.T) {
	tests := []struct {
		...
		{commandID: FeishuCommandProject, wantKind: ActionProjectCockpit, wantSlash: "/project"},
		{commandID: FeishuCommandContinue, wantKind: ActionProjectContinue, wantSlash: "/continue"},
...
func TestFeishuRecommendedMenusStayInSuggestedOrder(t *testing.T) {
	...
	want := []FeishuRecommendedMenu{
		{Key: "project", Name: "项目", Description: "打开当前项目驾驶舱，查看进度和下一步操作。"},
