...
var feishuCommandDisplayProfiles = map[string]FeishuCommandDisplayProfile{
	"codex": newFeishuCommandDisplayProfile("codex", true,
		commandSupportVisible(FeishuCommandProject),
		commandSupportVisible(FeishuCommandContinue),
		commandSupportHiddenAllowed(FeishuCommandNow),
		...
		commandSupportVisible(FeishuCommandWhere),
